...
{
    public class JapanShippingFactory:IShippingFactory
    {
        public IShippingProfile CreateShippingProfile() => new JapanShippingProfile();
        public IRegulation CreateRegulation() => new JapanRegulation();
    }
}
